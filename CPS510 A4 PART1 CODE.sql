...
DROP VIEW CLUBS_THAT_HAVE_MEMBERS_SUMMER2024;

CREATE VIEW CLUBS_THAT_HAVE_MEMBERS_SUMMER2024 AS
SELECT DISTINCT CLUBS.CLUB_NAME, CLUBS.HOME_CITY, CLUBS.HOME_STADIUM FROM CLUBS, MEMBERSHIP_LOG, SEASONS
WHERE CLUBS.CLUB_NAME IN (MEMBERSHIP_LOG.CLUB)
AND MEMBERSHIP_LOG.SEASON = SEASONS;

SELECT * FROM CLUBS_THAT_HAVE_MEMBERS_SUMMER2024;
